...
const SwitchButton: React.FC<SwitchButtonProps> = ({
  ...
  return (
      <Tooltip label={hint}>
          <button
              onClick={onClick}
              className="rounded-full w-8 h-8 flex items-center justify-center opacity-50 duration-200 z-10 text-gray-500 hover:bg-gray-900 hover:opacity-100! hover:text-white! transition-opacity"
              aria-label={hint}
          >
              <svg
                  width="24"
